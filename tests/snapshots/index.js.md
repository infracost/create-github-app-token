...
> stdout
    ...
    GET /api/v3/repos/actions/create-github-app-token`
...
> stdout
    ...
    GET /repos/actions/create-github-app-token`

## main-repo-access-validation-retry.test.js
...
> stdout
    ...
    Token is valid.␊
    Validating repository access...␊
    Repository access validation failed for actions/create-github-app-token (attempt 1): undefined␊
    All repositories are accessible.␊
    ::add-mask::ghs_16C7e42F292c6912E7710c838347Ae178B4a␊
    ␊
    ::set-output name=token::ghs_16C7e42F292c6912E7710c838347Ae178B4a␊
...
## main-repo-access-validation.test.js
